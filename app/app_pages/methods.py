...
with st.expander("Statistical methods", icon=":material/query_stats:"):
    ...
    st.write(
        ...
        "they land on a breakpoint near March 2020 without being told to. Disagreement here "
        "is **not** itself evidence against a significant result — the primary method tests "
        "one specific, pre-registered date, while PELT/binseg search the whole series for "
        "whichever single breakpoint fits best, which can legitimately fall elsewhere without "
        "the 2020 date being wrong. On the real data, 3 of 6 test causes (heart disease, "
        "diabetes, cerebrovascular disease) show this disagreement despite a large, significant "
        "primary-method result for each."
    )
    st.write(
